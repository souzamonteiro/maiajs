...
(module
  ...
  (data (i32.const 16) "Write a word: \00")
  (data (i32.const 32) "%s\00")
  (data (i32.const 36) "%c\00")
  (data (i32.const 40) "\0a\00")
  (data (i32.const 44) "Address pointed to by p: %ld\0a\00")
  (data (i32.const 76) "Text in uppercase: \00")

  (elem (table $fn_table) (i32.const 0) func $__cpp_toupper $to_uppercase__pvpv $main)
