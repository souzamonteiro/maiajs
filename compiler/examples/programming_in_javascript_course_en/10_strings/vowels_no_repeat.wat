...
(module
  ...
  (data (i32.const 60) " unique vowels.\0a\00")

  (elem (table $fn_table) (i32.const 0) func $__cpp_tolower $count_unique_vowels__pv $main)
  ...
  ;; function count_unique_vowels__pv
  (func $count_unique_vowels__pv (param $name i32) (result i32)
    (local $__frame i32)
    (local $i i32)
    (local $na i32)
    (local $ne i32)
    ...
    (local $nu i32)
    (local $__tmp_i32 i32)
    (local $count_unique_vowels__pv___switch_value_4 i32)
    (local $count_unique_vowels__pv___switch_matched_5 i32)
    ...
    local.get $__tmp_i32
    drop
    block $count_unique_vowels__pv_for_exit_0
      loop $count_unique_vowels__pv_for_loop_2
        local.get $__frame
        i32.const 4
        i32.add
        i32.load
        ...
        i32.eqz
        i32.eqz
        br_if $count_unique_vowels__pv_for_exit_0
        block $count_unique_vowels__pv_for_continue_1
          local.get $__frame
          i32.const 0
          i32.add
          i32.load
          ...
          i32.load8_u
          call $__cpp_tolower
          local.set $count_unique_vowels__pv___switch_value_4
          i32.const 0
          local.set $count_unique_vowels__pv___switch_matched_5
          block $count_unique_vowels__pv_switch_exit_3
            local.get $count_unique_vowels__pv___switch_matched_5
            if
              local.get $__frame
              i32.const 8
              i32.add
              ...
              br $count_unique_vowels__pv_switch_exit_3
            else
              local.get $count_unique_vowels__pv___switch_value_4
              i32.const 97
              i32.eq
              if
                i32.const 1
        ...
        local.get $__tmp_old_i32
        drop
        br $count_unique_vowels__pv_for_loop_2
      end
    end
    local.get $__frame
    i32.const 8
  ...
  (export "count_unique_vowels__pv" (func $count_unique_vowels__pv))
