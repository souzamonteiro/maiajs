...
(module
  ...
  (elem (table $fn_table) (i32.const 0) func $Polygon_init $Polygon_destroy $Polygon_setValues__ii $Rectangle_init $Rectangle_destroy $Rectangle_calcArea $Triangle_init $Triangle_destroy $Triangle_calcArea $main)
