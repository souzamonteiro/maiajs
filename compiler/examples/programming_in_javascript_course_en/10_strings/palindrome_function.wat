...
(module
  ...
  (func $is_palindrome__pv (param $word i32) (result i32)
    ...
    local.get $__tmp_i32
    drop
    block $is_palindrome__pv_for_exit_0
      loop $is_palindrome__pv_for_loop_2
        local.get $__frame
        i32.const 4
        i32.add
        i32.load
        ...
        i32.eqz
        i32.eqz
        br_if $is_palindrome__pv_for_exit_0
        block $is_palindrome__pv_for_continue_1
          local.get $__frame
          i32.const 0
          i32.add
          i32.load
        ...
        local.get $__tmp_old_i32
        drop
        br $is_palindrome__pv_for_loop_2
      end
    end
    local.get $__frame
    i32.const 12
