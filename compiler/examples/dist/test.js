...
(function buildEnv(getMemory, opts = {}) {
  ...
  return {
    ...
    "__b__value": () => { const target = __resolveHost(["b","value"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
