...
(module
  ...
  (data (i32.const 40) "You are \00")
  (data (i32.const 52) " years old.\00")
  (data (i32.const 64) "\0a\00")
  (data (i32.const 68) "Enter your height in meters: \00")
  (data (i32.const 100) "%f\00")
  (data (i32.const 104) "%g\00")
  (data (i32.const 108) " meters tall.\00")
  (data (i32.const 124) "Enter your name: \00")
  (data (i32.const 144) "%s\00")
  (data (i32.const 148) "Hello \00")
