...
(module
  ...
  (data (i32.const 60) "Temperature in Celsius: \00")
  (data (i32.const 88) "%g\00")
  (data (i32.const 92) ".\0a\00")

  (elem (table $fn_table) (i32.const 0) func $celsius__f $main)

  ;; function celsius__f
  (func $celsius__f (param $f f32) (result f32)
    local.get $f
    i32.const 32
    f32.convert_i32_s
    f32.sub
  ...
  (export "celsius__f" (func $celsius__f))
