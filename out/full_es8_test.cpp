...
int __maia_fn_Animal_prototype_accessPrivate(void) {
  return (int)(_animalPrivate(this).privateField);
}
...
void* __new__Animal(int name, int species) {
  ...
  _animalPrivate(__maia_this, __maia_obj_literal1("privateField", (int)("private value")));
...
int main() {
  ...
  double a = 10;
  double b = 3;
  +(__console__log("Arithmetic add: " + +(a + b)));
  +(__console__log("Arithmetic sub: " + -(a - b)));
  +(__console__log("Arithmetic mul: " + a * b));
  +(__console__log("Arithmetic div: " + a / b));
  +(__console__log("Arithmetic mod: " + (int)(a) % (int)(b)));
  +(__console__log("Arithmetic exp (**): " + b));
  double x = 5;
  x += 3;
  x -= 2;
  x *= 4;
  ...
  +(__console__log("Comparison 5 == \"5\": " + 5 == "5"));
  +(__console__log("Comparison 5 === \"5\": " + 5 == "5"));
  +(__console__log("Bitwise 5 & 3: " + (int)(5) & (int)(3)));
  +(__console__log("Bitwise 5 | 3: " + (int)(5) | (int)(3)));
  ...
  const double doubled = __numbers__map(__maia_lambda1());
  const double evens = __numbers__filter(__maia_lambda1());
  const double sum = +(__numbers__reduce(__maia_lambda2(), 0));
  ...
  +(__console__log("Dog instanceof Animal: " + (dynamic_cast<Animal*>(dog) != 0)));
  __console__log("\n--- SECTION 8: PROMISES ---");
  +(delay(10, "A"));
  ...
  +(__console__log("Symbol equality: " + sym1 == sym2));
  ...
  const void* setLike = __arr__indexOf(v) == i;
