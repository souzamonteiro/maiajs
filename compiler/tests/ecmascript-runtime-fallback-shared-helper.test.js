...
test('runtime fallback dedup: mixed sync and async overflow hooks reuse one shared lambda payload allocator', () => {
  ...
  assert.match(cpp, /static int __maia_runtime_lambda_known_case_matches_function_id\(void\* lambda_value, int function_id\) \{[\s\S]*case 1005:[\s\S]*if \(__maia_runtime_lambda_get_arity\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*if \(__maia_runtime_lambda_get_is_async\(lambda_value\) != 0\) \{ return 0; \}[\s\S]*return 1;/,
    'metadata-match helper should validate sync overflow known-case arity/async guards');
  assert.match(cpp, /static int __maia_runtime_lambda_has_known_case\(int function_id\) \{[\s\S]*case 1005:[\s\S]*return 1;/,
    'known-case membership helper should recognize sync overflow known-case function ids');
  assert.match(cpp, /static int __maia_runtime_lambda_invoke_known_case\(void\* lambda_value, int function_id, int argc\) \{[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);[\s\S]*\}/,
  ...
  assert.match(cpp, /static int __maia_runtime_lambda_known_case_matches_function_id\(void\* lambda_value, int function_id\) \{[\s\S]*case 1001005:[\s\S]*if \(__maia_runtime_lambda_get_arity\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*if \(__maia_runtime_lambda_get_is_async\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*return 1;/,
    'metadata-match helper should validate async overflow known-case arity/async guards');
  assert.match(cpp, /static int __maia_runtime_lambda_has_known_case\(int function_id\) \{[\s\S]*case 1001005:[\s\S]*return 1;/,
...
test('runtime fallback dedup: mid-profile known cases (2..4 captures) omit capture-index-4 and carry family constant', () => {
  ...
  assert.match(cpp, /static int __maia_runtime_lambda_known_case_matches_function_id\(void\* lambda_value, int function_id\) \{[\s\S]*case 1002:[\s\S]*if \(__maia_runtime_lambda_get_arity\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*if \(__maia_runtime_lambda_get_is_async\(lambda_value\) != 0\) \{ return 0; \}[\s\S]*return 1;/,
    'metadata-match helper should validate sync mid-profile known-case arity/async guards');
  assert.match(cpp, /case 1002:[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);/,
  ...
  assert.match(cpp, /static int __maia_runtime_lambda_known_case_matches_function_id\(void\* lambda_value, int function_id\) \{[\s\S]*case 1001002:[\s\S]*if \(__maia_runtime_lambda_get_arity\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*if \(__maia_runtime_lambda_get_is_async\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*return 1;/,
    'metadata-match helper should validate async mid-profile known-case arity/async guards');
  assert.match(cpp, /case 1001002:[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);/,
...
test('runtime fallback dedup: multi-arg known cases carry arity-family constant', () => {
  ...
  assert.match(cpp, /static int __maia_runtime_lambda_known_case_matches_function_id\(void\* lambda_value, int function_id\) \{[\s\S]*case 2001:[\s\S]*if \(__maia_runtime_lambda_get_arity\(lambda_value\) != 2\) \{ return 0; \}[\s\S]*if \(__maia_runtime_lambda_get_is_async\(lambda_value\) != 0\) \{ return 0; \}[\s\S]*return 1;/,
    'metadata-match helper should validate sync multi-arg known-case arity/async guards');
  assert.match(cpp, /case 2001:[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);/,
    'known sync multi-arg function-id case should include reusable known-case token after metadata guards');

  assert.match(cpp, /static int __maia_runtime_lambda_known_case_matches_function_id\(void\* lambda_value, int function_id\) \{[\s\S]*case 1002001:[\s\S]*if \(__maia_runtime_lambda_get_arity\(lambda_value\) != 2\) \{ return 0; \}[\s\S]*if \(__maia_runtime_lambda_get_is_async\(lambda_value\) != 1\) \{ return 0; \}[\s\S]*return 1;/,
    'metadata-match helper should validate async multi-arg known-case arity/async guards');
  assert.match(cpp, /case 1002001:[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);/,
...
test('runtime fallback dedup: exact capture-count term differentiates three-capture and four-capture known cases', () => {
  ...
  assert.match(cpp, /case 1003:[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);/,
    'known three-capture function-id case should include reusable known-case token after metadata guards');

  assert.match(cpp, /case 1004:[\s\S]*return known_case_polarity \* \(weighted_capture_value \+ argc \+ known_case_token\);/,
