...
(function buildEnv(getMemory) {
  ...
  return {
    ...
    "__Array__prototype__slice__call": (p0) => Array.prototype.slice.call(p0),
    "__arrowFunc": (p0) => arrowFunc(p0),
    "__Object__values": () => Object.values(),
    "__Object__entries": () => Object.entries(),
    "__Object__getOwnPropertyDescriptors": () => Object.getOwnPropertyDescriptors(),
    "__str__padStart": (p0, p1) => str.padStart(p0, p1),
    "__str__padEnd": (p0, p1) => str.padEnd(p0, p1),
    "__numbers__map": () => numbers.map(),
    "__numbers__filter": () => numbers.filter(),
    "__numbers__reduce": (p0) => numbers.reduce(p0),
    "__numbers__includes": (p0) => numbers.includes(p0),
    "___animalPrivate": () => _animalPrivate(),
    "__Animal__call": (p0) => Animal.call(p0),
    "__Object__create": () => Object.create(),
    "__genericAnimal__speak": () => genericAnimal.speak(),
    "__genericAnimal__getDescription": () => genericAnimal.getDescription(),
    "__genericAnimal__setNickname": (p0) => genericAnimal.setNickname(p0),
    "__genericAnimal__getNickname": () => genericAnimal.getNickname(),
    "__Animal__classify": () => Animal.classify(),
    "__genericAnimal__accessPrivate": () => genericAnimal.accessPrivate(),
    "__dog__speak": () => dog.speak(),
    "__setTimeout": () => setTimeout(),
    "__resolve": () => resolve(),
    "__Promise__resolve": (p0) => Promise.resolve(p0),
    "__Symbol": (p0) => Symbol(p0),
    "__rangeValues__forEach": () => rangeValues.forEach(),
    "__Reflect": (p0, p1) => Reflect(p0, p1),
    "__Reflect__ownKeys": () => Reflect.ownKeys(),
    "__arr__indexOf": () => arr.indexOf(),
    "__maia_obj_literal0": () => maia_obj_literal0(),
    "__maia_obj_literal1": (p0, p1) => maia_obj_literal1(readCString(p0), p1),
    "__maia_obj_literal2": (p0, p1, p2, p3) => maia_obj_literal2(readCString(p0), p1, readCString(p2), p3),
    "__maia_obj_literal3": (p0, p1, p2, p3, p4, p5) => maia_obj_literal3(readCString(p0), p1, readCString(p2), p3, readCString(p4), p5),
    "__maia_obj_literal4": (p0, p1, p2, p3, p4, p5, p6, p7) => maia_obj_literal4(readCString(p0), p1, readCString(p2), p3, readCString(p4), p5, readCString(p6), p7),
    "__maia_arr_literal0": () => maia_arr_literal0(),
    "__maia_arr_literal1": (p0) => maia_arr_literal1(p0),
    "__maia_arr_literal2": (p0, p1) => maia_arr_literal2(p0, p1),
    "__maia_arr_literal3": (p0, p1, p2) => maia_arr_literal3(p0, p1, p2),
    "__maia_arr_literal4": (p0, p1, p2, p3) => maia_arr_literal4(p0, p1, p2, p3),
    "__maia_arr_builder_begin": () => maia_arr_builder_begin(),
    "__maia_arr_builder_push_value": (p0, p1) => maia_arr_builder_push_value(p0, p1),
    "__maia_arr_builder_push_hole": (p0) => maia_arr_builder_push_hole(p0),
    "__maia_arr_builder_spread": (p0, p1) => maia_arr_builder_spread(p0, p1),
    "__maia_arr_builder_end": (p0) => maia_arr_builder_end(p0),
    "__maia_lambda0_capture2": (p0, p1) => maia_lambda0_capture2(p0, p1),
    "__maia_lambda1": () => maia_lambda1(),
    "__maia_lambda1_capture1": (p0) => maia_lambda1_capture1(p0),
    "__maia_lambda2": () => maia_lambda2(),
    "__maia_fn_Animal_prototype_speak": () => maia_fn_Animal_prototype_speak(),
    "__maia_fn_Animal_prototype_getDescription": () => maia_fn_Animal_prototype_getDescription(),
    "__maia_fn_Animal_prototype_setNickname": (p0) => maia_fn_Animal_prototype_setNickname(p0),
    "__maia_fn_Animal_prototype_getNickname": () => maia_fn_Animal_prototype_getNickname(),
    "__maia_fn_Animal_classify": () => maia_fn_Animal_classify(),
    "__maia_fn_Animal_prototype_accessPrivate": () => maia_fn_Animal_prototype_accessPrivate(),
    "__maia_fn_Dog_prototype_speak": () => maia_fn_Dog_prototype_speak(),
    "__maia_fn_person_greet": () => maia_fn_person_greet(),
    "__maia_fn_arg_rangeValues_forEach_0": (p0) => maia_fn_arg_rangeValues_forEach_0(p0),
    "__maia_fn_arg_call_0": (p0, p1, p2) => maia_fn_arg_call_0(p0, p1, p2),
    "__new__Animal": (p0, p1) => new Animal(p0, p1),
    "__new__Dog": (p0, p1) => new Dog(p0, p1),
  };
});
