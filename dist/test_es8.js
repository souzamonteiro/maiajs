...
(function buildEnv(getMemory) {
  ...
  return {
    ...
    "__Array__prototype__slice__call": (p0, p1) => { const target = __resolveHost(["Array","prototype","slice","call"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue, p0, p1); return (result ?? 0); },
    "__arrowFunc": (p0) => { const target = __resolveHost(["arrowFunc"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, readCString(p0)); return undefined; },
    "__Object__values": (p0) => { const target = __resolveHost(["Object","values"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__Object__entries": (p0) => { const target = __resolveHost(["Object","entries"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__Object__getOwnPropertyDescriptors": (p0) => { const target = __resolveHost(["Object","getOwnPropertyDescriptors"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__str__padStart": (p0, p1) => { const target = __resolveHost(["str","padStart"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, readCString(p1)); return undefined; },
    "__str__padEnd": (p0, p1) => { const target = __resolveHost(["str","padEnd"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, readCString(p1)); return undefined; },
    "__numbers__map": (p0) => { const target = __resolveHost(["numbers","map"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__numbers__filter": (p0) => { const target = __resolveHost(["numbers","filter"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__numbers__reduce": (p0, p1) => { const target = __resolveHost(["numbers","reduce"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, p1); return undefined; },
    "__numbers__includes": (p0) => { const target = __resolveHost(["numbers","includes"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "___animalPrivate": (p0, p1) => { const target = __resolveHost(["_animalPrivate"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, p1); return undefined; },
    "__Animal__call": (p0, p1, p2) => { const target = __resolveHost(["Animal","call"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, p1, readCString(p2)); return undefined; },
    "__Object__create": (p0) => { const target = __resolveHost(["Object","create"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__genericAnimal__speak": () => { const target = __resolveHost(["genericAnimal","speak"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
    "__genericAnimal__getDescription": () => { const target = __resolveHost(["genericAnimal","getDescription"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
    "__genericAnimal__setNickname": (p0) => { const target = __resolveHost(["genericAnimal","setNickname"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, readCString(p0)); return undefined; },
    "__genericAnimal__getNickname": () => { const target = __resolveHost(["genericAnimal","getNickname"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
    "__Animal__classify": () => { const target = __resolveHost(["Animal","classify"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
    "__genericAnimal__accessPrivate": () => { const target = __resolveHost(["genericAnimal","accessPrivate"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
    "__dog__speak": () => { const target = __resolveHost(["dog","speak"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue); return undefined; },
    "__setTimeout": (p0, p1) => { const target = __resolveHost(["setTimeout"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, p1); return undefined; },
    "__resolve": (p0) => { const target = __resolveHost(["resolve"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__Promise__resolve": (p0) => { const target = __resolveHost(["Promise","resolve"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__Symbol": (p0) => { const target = __resolveHost(["Symbol"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, readCString(p0)); return undefined; },
    "__rangeValues__forEach": (p0) => { const target = __resolveHost(["rangeValues","forEach"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__Reflect": (p0, p1, p2) => { const target = __resolveHost(["Reflect"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0, readCString(p1), p2); return undefined; },
    "__Reflect__ownKeys": (p0) => { const target = __resolveHost(["Reflect","ownKeys"]); if (typeof target.fn !== 'function') return undefined; const result = target.fn.call(target.thisValue, p0); return undefined; },
    "__arr__indexOf": (p0) => { const target = __resolveHost(["arr","indexOf"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue, p0); return (result ?? 0); },
    "__maia_fn_Animal_prototype_setNickname": (p0) => { const target = __resolveHost(["maia_fn_Animal_prototype_setNickname"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue, p0); return (result ?? 0); },
    "__maia_fn_Animal_prototype_getNickname": () => { const target = __resolveHost(["maia_fn_Animal_prototype_getNickname"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue); return (result ?? 0); },
    "__maia_fn_Animal_prototype_accessPrivate": () => { const target = __resolveHost(["maia_fn_Animal_prototype_accessPrivate"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue); return (result ?? 0); },
    "__maia_fn_arg_rangeValues_forEach_0": (p0) => { const target = __resolveHost(["maia_fn_arg_rangeValues_forEach_0"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue, p0); return (result ?? 0); },
    "__maia_fn_arg_call_0": (p0, p1, p2) => { const target = __resolveHost(["maia_fn_arg_call_0"]); if (typeof target.fn !== 'function') return 0; const result = target.fn.call(target.thisValue, p0, p1, p2); return (result ?? 0); },
  };
});
