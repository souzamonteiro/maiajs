...
(module
  ...
  (elem (table $fn_table) (i32.const 0) func $Rectangle_init__ii $Rectangle_init $Rectangle_destroy $Rectangle_setValues__ii $Rectangle_calcArea $main)

  ;; function Rectangle_init__ii
  (func $Rectangle_init__ii (param $self i32) (param $a i32) (param $b i32)
    (local $__frame i32)
    (local $__tmp_i32 i32)
  ...
  ;; function Rectangle_setValues__ii
  (func $Rectangle_setValues__ii (param $self i32) (param $a i32) (param $b i32)
    (local $__frame i32)
    (local $__tmp_i32 i32)
    (local $__parent_frame i32)
    global.get $__frame_ptr
  ...
  (export "Rectangle_init__ii" (func $Rectangle_init__ii))
  (export "Rectangle_init" (func $Rectangle_init))
  (export "Rectangle_destroy" (func $Rectangle_destroy))
  (export "Rectangle_setValues__ii" (func $Rectangle_setValues__ii))
